...
import google from '../../images/download_google.png';
import apple from '../../images/download_apple.png';

const Footer = () => {
    return (
        <footer className="mt-6 footer p-10 bg-white-100 text-base-content">
            <div>
                <span className="footer-title">Services</span>
                <a className="link link-hover">CAR ACCESSORIES</a>
                <a className="link link-hover">BODY PARTS</a>
                <a className="link link-hover">ENGINE PARTS</a>
                <a className="link link-hover">FUEL SYSTEM</a>
            </div>
            <div>
